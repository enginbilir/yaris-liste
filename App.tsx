...
const App: React.FC = () => {
  ...
  const baseFilename = file ? file.name.replace(/\.[^/.]+$/, '') : 'sonuclar';
          ...
          {!processedData ? (
            ...
            <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  onClick={() => downloadFile(generateCsvContent(), `${baseFilename}.csv`, 'text/csv;charset=utf-8;')}
                ...
                <button
                  onClick={() => downloadFile(generateTxtContent(), `${baseFilename}.txt`, 'text/plain;charset=utf-8;')}
